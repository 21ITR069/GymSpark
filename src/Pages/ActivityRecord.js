...
const ActivityRecord = () => {
  ...
  return (
    <>
      <div className="row m-auto mt-5 text-white bg-orange-500">
        {data.length === 0 ? (
      ...
      {editBoxshow && (
        <div className="bg-white text-dark">
          ...
          >
            ...
            <input
              className="border border-dark w-full p-0.5"
              type="text"
              name="description"
            ...
            <div className="flex justify-center mt-3">
              <button
                className="bg-black p-3 rounded-full text-red-800 font-bold hover:bg-black"
